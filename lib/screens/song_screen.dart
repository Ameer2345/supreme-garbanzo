...
import 'package:music_app/Widget/SeekBarData.dart';
import 'package:music_app/models/SongModels.dart';
import 'package:rxdart/rxdart.dart' as rxdart;

import '../Widget/PlayersButtons.dart';
  ...
  Widget build(BuildContext context){
    ...
    return Scaffold(
      ...
      gradient: LinearGradient(
        ...
        colors: [
          Colors.blueGrey.shade500.withOpacity(0.1),
          Colors.blueGrey.shade600.withOpacity(0.1),
      ...
      child: Column(
        ...
        children: [
          ...
          builder: (context, snapshot) {
            ...
            return SeekBar(position: positionData?.duration
            ?? Duration.zero
